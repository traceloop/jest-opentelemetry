        ...
        v1.ResourceSpans = (function () {
          ...
          ResourceSpans.verify = function verify(message) {
            ...
            if (
              ...
              let error = $root.opentelemetry.proto.resource.v1.Resource.verify(
                message.resource,
              );
        ...
        v1.ScopeSpans = (function () {
          ...
          ScopeSpans.verify = function verify(message) {
            ...
            if (message.spans != null && message.hasOwnProperty('spans')) {
              ...
              for (let i = 0; i < message.spans.length; ++i) {
                let error = $root.opentelemetry.proto.trace.v1.Span.verify(
                  message.spans[i],
                );
        ...
        v1.Span = (function () {
          ...
          Span.verify = function verify(message) {
            ...
            if (
              ...
              for (let i = 0; i < message.attributes.length; ++i) {
                let error = $root.opentelemetry.proto.common.v1.KeyValue.verify(
                  message.attributes[i],
                );
            ...
            if (message.links != null && message.hasOwnProperty('links')) {
              ...
              for (let i = 0; i < message.links.length; ++i) {
                let error = $root.opentelemetry.proto.trace.v1.Span.Link.verify(
                  message.links[i],
                );
            ...
            if (message.status != null && message.hasOwnProperty('status')) {
              let error = $root.opentelemetry.proto.trace.v1.Status.verify(
                message.status,
              );
        ...
        v1.ArrayValue = (function () {
          ...
          ArrayValue.verify = function verify(message) {
            ...
            if (message.values != null && message.hasOwnProperty('values')) {
              ...
              for (let i = 0; i < message.values.length; ++i) {
                let error = $root.opentelemetry.proto.common.v1.AnyValue.verify(
                  message.values[i],
                );
