...
export const traceloop = $root.traceloop = (() => {
    ...
    traceloop.proto = (function() {
        ...
        proto.traceloop = (function() {

            /**
             * Namespace traceloop.
             * @memberof traceloop.proto
             * @namespace
             */
            const traceloop = {};

            traceloop.v1 = (function() {

                /**
                 * Namespace v1.
                 * @memberof traceloop.proto.traceloop
                 * @namespace
                 */
                const v1 = {};

                v1.TraceloopSpan = (function() {

                    /**
                     * Properties of a TraceloopSpan.
                     * @memberof traceloop.proto.traceloop.v1
                     * @interface ITraceloopSpan
                     * @property {opentelemetry.proto.resource.v1.IResource|null} [resource] TraceloopSpan resource
                     * @property {opentelemetry.proto.common.v1.IInstrumentationScope|null} [scope] TraceloopSpan scope
                     * @property {opentelemetry.proto.trace.v1.ISpan|null} [span] TraceloopSpan span
                     * @property {string|null} [traceId] TraceloopSpan traceId
                     * @property {string|null} [spanId] TraceloopSpan spanId
                     * @property {string|null} [parentSpanId] TraceloopSpan parentSpanId
                     * @property {string|null} [customerId] TraceloopSpan customerId
                     * @property {string|null} [traceloopId] TraceloopSpan traceloopId
                     */

                    /**
                     * Constructs a new TraceloopSpan.
                     * @memberof traceloop.proto.traceloop.v1
                     * @classdesc Represents a TraceloopSpan.
                     * @implements ITraceloopSpan
                     * @constructor
                     * @param {traceloop.proto.traceloop.v1.ITraceloopSpan=} [properties] Properties to set
                     */
                    function TraceloopSpan(properties) {
                        if (properties)
                            for (let keys = Object.keys(properties), i = 0; i < keys.length; ++i)
                                if (properties[keys[i]] != null)
                                    this[keys[i]] = properties[keys[i]];
                     ...
                     * @member {opentelemetry.proto.resource.v1.IResource|null|undefined} resource
                     * @memberof traceloop.proto.traceloop.v1.TraceloopSpan
                     * @instance
                     */
                    TraceloopSpan.prototype.resource = null;
                     ...
                     * @instance
                     */
                    TraceloopSpan.prototype.scope = null;

                    /**
                     * TraceloopSpan span.
                     * @member {opentelemetry.proto.trace.v1.ISpan|null|undefined} span
                     * @memberof traceloop.proto.traceloop.v1.TraceloopSpan
                     * @instance
                     */
                    TraceloopSpan.prototype.span = null;
                     ...
                     * @instance
                     */
                    TraceloopSpan.prototype.traceId = "";
                     ...
                     * @instance
                     */
                    TraceloopSpan.prototype.spanId = "";
                     ...
                     * @instance
                     */
                    TraceloopSpan.prototype.parentSpanId = "";
                     ...
                     * @instance
                     */
                    TraceloopSpan.prototype.customerId = "";

                    /**
                     * TraceloopSpan traceloopId.
                     * @member {string} traceloopId
                     * @memberof traceloop.proto.traceloop.v1.TraceloopSpan
                     * @instance
                     */
                    TraceloopSpan.prototype.traceloopId = "";
                     ...
                     * @static
                     * @param {traceloop.proto.traceloop.v1.ITraceloopSpan=} [properties] Properties to set
                     * @returns {traceloop.proto.traceloop.v1.TraceloopSpan} TraceloopSpan instance
                     */
                    TraceloopSpan.create = function create(properties) {
                        return new TraceloopSpan(properties);
                    };
                     ...
                     * @memberof traceloop.proto.traceloop.v1.TraceloopSpan
                     * @static
                     * @param {traceloop.proto.traceloop.v1.ITraceloopSpan} message TraceloopSpan message or plain object to encode
                     * @param {$protobuf.Writer} [writer] Writer to encode to
                     * @returns {$protobuf.Writer} Writer
                     */
                    TraceloopSpan.encode = function encode(message, writer) {
                        if (!writer)
                            writer = $Writer.create();
                        if (message.resource != null && Object.hasOwnProperty.call(message, "resource"))
                            $root.opentelemetry.proto.resource.v1.Resource.encode(message.resource, writer.uint32(/* id 1, wireType 2 =*/10).fork()).ldelim();
                        if (message.scope != null && Object.hasOwnProperty.call(message, "scope"))
                            $root.opentelemetry.proto.common.v1.InstrumentationScope.encode(message.scope, writer.uint32(/* id 2, wireType 2 =*/18).fork()).ldelim();
                        if (message.span != null && Object.hasOwnProperty.call(message, "span"))
                            $root.opentelemetry.proto.trace.v1.Span.encode(message.span, writer.uint32(/* id 3, wireType 2 =*/26).fork()).ldelim();
                        if (message.traceId != null && Object.hasOwnProperty.call(message, "traceId"))
                            writer.uint32(/* id 4, wireType 2 =*/34).string(message.traceId);
                        if (message.spanId != null && Object.hasOwnProperty.call(message, "spanId"))
                            writer.uint32(/* id 5, wireType 2 =*/42).string(message.spanId);
                        if (message.parentSpanId != null && Object.hasOwnProperty.call(message, "parentSpanId"))
                            writer.uint32(/* id 6, wireType 2 =*/50).string(message.parentSpanId);
                        if (message.customerId != null && Object.hasOwnProperty.call(message, "customerId"))
                            writer.uint32(/* id 7, wireType 2 =*/58).string(message.customerId);
                        if (message.traceloopId != null && Object.hasOwnProperty.call(message, "traceloopId"))
                            writer.uint32(/* id 8, wireType 2 =*/66).string(message.traceloopId);
                        return writer;
                    };
                     ...
                     * @returns {$protobuf.Writer} Writer
                     */
                    TraceloopSpan.encodeDelimited = function encodeDelimited(message, writer) {
                        return this.encode(message, writer).ldelim();
                    };
                     ...
                     * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
                     * @param {number} [length] Message length if known beforehand
                     * @returns {traceloop.proto.traceloop.v1.TraceloopSpan} TraceloopSpan
                     * @throws {Error} If the payload is not a reader or valid buffer
                     * @throws {$protobuf.util.ProtocolError} If required fields are missing
                     */
                    TraceloopSpan.decode = function decode(reader, length) {
                        if (!(reader instanceof $Reader))
                            reader = $Reader.create(reader);
                        let end = length === undefined ? reader.len : reader.pos + length, message = new $root.traceloop.proto.traceloop.v1.TraceloopSpan();
                        while (reader.pos < end) {
                            let tag = reader.uint32();
                            switch (tag >>> 3) {
                            case 1: {
                            ...
                            case 3: {
                                    message.span = $root.opentelemetry.proto.trace.v1.Span.decode(reader, reader.uint32());
                                    break;
                                }
                            case 4: {
                            ...
                            case 8: {
                                    message.traceloopId = reader.string();
                                    break;
                                }
                            default:
                                reader.skipType(tag & 7);
                     ...
                     * @throws {$protobuf.util.ProtocolError} If required fields are missing
                     */
                    TraceloopSpan.decodeDelimited = function decodeDelimited(reader) {
                        if (!(reader instanceof $Reader))
                            reader = new $Reader(reader);
                        return this.decode(reader, reader.uint32());
                    };
                     ...
                     * @returns {string|null} `null` if valid, otherwise the reason why it is not
                     */
                    TraceloopSpan.verify = function verify(message) {
                        if (typeof message !== "object" || message === null)
                            return "object expected";
                        if (message.resource != null && message.hasOwnProperty("resource")) {
                            let error = $root.opentelemetry.proto.resource.v1.Resource.verify(message.resource);
                        ...
                        if (message.span != null && message.hasOwnProperty("span")) {
                            let error = $root.opentelemetry.proto.trace.v1.Span.verify(message.span);
                            if (error)
                                return "span." + error;
                        }
                        if (message.traceId != null && message.hasOwnProperty("traceId"))
                        ...
                        if (message.traceloopId != null && message.hasOwnProperty("traceloopId"))
                            if (!$util.isString(message.traceloopId))
                                return "traceloopId: string expected";
                        return null;
                    };
                     ...
                     * @returns {traceloop.proto.traceloop.v1.TraceloopSpan} TraceloopSpan
                     */
                    TraceloopSpan.fromObject = function fromObject(object) {
                        if (object instanceof $root.traceloop.proto.traceloop.v1.TraceloopSpan)
                            return object;
                        let message = new $root.traceloop.proto.traceloop.v1.TraceloopSpan();
                        if (object.resource != null) {
                            if (typeof object.resource !== "object")
                                throw TypeError(".traceloop.proto.traceloop.v1.TraceloopSpan.resource: object expected");
                            message.resource = $root.opentelemetry.proto.resource.v1.Resource.fromObject(object.resource);
                        }
                        if (object.scope != null) {
                            if (typeof object.scope !== "object")
                                throw TypeError(".traceloop.proto.traceloop.v1.TraceloopSpan.scope: object expected");
                            message.scope = $root.opentelemetry.proto.common.v1.InstrumentationScope.fromObject(object.scope);
                        }
                        if (object.span != null) {
                            if (typeof object.span !== "object")
                                throw TypeError(".traceloop.proto.traceloop.v1.TraceloopSpan.span: object expected");
                            message.span = $root.opentelemetry.proto.trace.v1.Span.fromObject(object.span);
                        }
                        if (object.traceId != null)
                        ...
                        if (object.traceloopId != null)
                            message.traceloopId = String(object.traceloopId);
                        return message;
                    };
                     ...
                     * @memberof traceloop.proto.traceloop.v1.TraceloopSpan
                     * @static
                     * @param {traceloop.proto.traceloop.v1.TraceloopSpan} message TraceloopSpan
                     * @param {$protobuf.IConversionOptions} [options] Conversion options
                     * @returns {Object.<string,*>} Plain object
                     */
                    TraceloopSpan.toObject = function toObject(message, options) {
                        if (!options)
                            options = {};
                        let object = {};
                        if (options.defaults) {
                        ...
                        if (message.scope != null && message.hasOwnProperty("scope"))
                            object.scope = $root.opentelemetry.proto.common.v1.InstrumentationScope.toObject(message.scope, options);
                        if (message.span != null && message.hasOwnProperty("span"))
                            object.span = $root.opentelemetry.proto.trace.v1.Span.toObject(message.span, options);
                        if (message.traceId != null && message.hasOwnProperty("traceId"))
                        ...
                        if (message.traceloopId != null && message.hasOwnProperty("traceloopId"))
                            object.traceloopId = message.traceloopId;
                        return object;
                    };
                     ...
                     * @returns {Object.<string,*>} JSON object
                     */
                    TraceloopSpan.prototype.toJSON = function toJSON() {
                        return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
                    };
                     ...
                     * @returns {string} The default type url
                     */
                    TraceloopSpan.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                        if (typeUrlPrefix === undefined) {
                            typeUrlPrefix = "type.googleapis.com";
                        }
                        return typeUrlPrefix + "/traceloop.proto.traceloop.v1.TraceloopSpan";
                    };

                    return TraceloopSpan;
                })();
